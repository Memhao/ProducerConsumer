...
public class Main {
	public static void main(String arg[])
	{
		...
		RotateStrategy rotate0 = new RotateStrategy("c0", block0);
		Producer p0 = new Producer("1",block0, "src/file.txt");
		Consumer c0 = new Consumer("1","c0",block0,rotate0);
		BlockingQueue<Message> block1 = new LinkedBlockingQueue<Message>();
		RotateStrategy rotate1 = new RotateStrategy("c1", block1);
		Producer p1 = new Producer("2",block1, "src/flie.txt");
		Consumer c1 = new Consumer("2","c1",block1,rotate1);
